...
<body>
	...
	<div class="content" id="content2">
	    <div class="row column text-center">
	      ...
	      <hr>
	      <div class="container">
		      	<form action="${path1 }/free/editPro.do" method="post">
				      <table id="table1">
				      	<tbody>
				      		<tr>
				      			<th style="background-color:#dcdcdc">글 제목</th>
				      			<td>
				      				<input type="hidden" name="bno" id="bno" value="${dto.bno }" readonly>
				      				<input type="text" name="title" id="title" value="${dto.title }" placeholder="제목 입력" maxlength="98" required>
				      			</td>
				      		</tr>
				      		<tr>
