...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
	...
	<div class="form-check">
		<input type="checkbox" id="ck_item2" name="ck_item"  class="form-check-input">
		<label for="ck_item2" class="form-check-label">개인 정보 처리 방침에 동의</label><br><br>
	</div><br><hr><br>
	<div class="form-check">
		<input type="checkbox" id="ck_item3" name="ck_item"  class="form-check-input">
		<label for="ck_item3" class="form-check-label">약관에 모두 동의</label><br><br>	  <div>
	  <br><hr><br>
	  <div class="btn group">
	  		<button type="button" id="in_btn1" class="button is-info">다음 단계로</button>
	  </div>	
	  </div>
	  <script>
	  	...
	  	in_btn1.addEventListener("click", function(){
	  		if(ck_item1.checked && ck_item2.checked) {
	  			...
	  			alert("약관 및 개인정보 처리 방침에 동의하지 않으셨습니다.");
	  			return;
	  		}
