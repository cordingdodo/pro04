						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<input type="text" name="postcode" id="postcode"  class="single40" value="${member.postcode }"  style="width:700px; float:left;">
									<input type="button" value="주소찾기" onclick="findAddr()" class="button">
								</td>
							</tr>
							<tr>
