		      ...
		      <table id="table1">
		      	<tbody>
		      		<tr>
		      			...
		      			<td>
		      				<input type="text" id="seq" id="seq" value="${dto.seq }" readonly>
		      			</td>
		      		</tr>
		      		<tr>
		      		...
		      		<tr>
		      			...
		      			<td>
		      				<textarea name="content" id="content" placeholder="내용 입력" rows="10" cols="100"  maxlength="1000" required>${dto.content }</textarea>
		      			</td>
		      		</tr>
		      		<tr>
				      	<td colspan="2">
